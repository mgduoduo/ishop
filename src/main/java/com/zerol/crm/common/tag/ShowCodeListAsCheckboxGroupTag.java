 ...
 */
public class ShowCodeListAsCheckboxGroupTag extends BaseTag {

    private final static Logger LOGGER = LoggerFactory.getLogger(ShowCodeListAsCheckboxGroupTag.class);
        ...
        try {
            ...
            if (codeList != null && !codeList.isEmpty()) {
                for(MyCode code: codeList){
                    ...
                    if(code.getCodeID().equals(value)){ //TODO Currently it's cannot for multiple values.
            ...
            LOGGER.debug("Failed to convert for checkbox, value="+value +", codeTypeID="+codeTypeID);
